    ...
    <div className="persona-layout">
      ...
      <div className="persona-cards-column">
        <div className="persona-cards-desktop">
          ...
          {/* Card 2: Vision Prompts */}
          <div className="info-card info-card--dotted">
            <div className="info-card-header" style={{ marginBottom: '24px', textAlign: 'center' }}>
              <h4 style={{ fontSize: '28px', letterSpacing: '1px' }}>VISION PROMPTS</h4>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div style={{ flex: 1, fontFamily: 'var(--font-mono)', fontSize: '13px' }}>
                  <strong>Scene Analysis:</strong> Understanding context and game state
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="holographic-afterimage persona-holographic">
        {/* Trail ghosts */}
        <img src="/lass/lass-speech.png" alt="" className="trail-ghost trail-1" aria-hidden="true" />
        <img src="/lass/lass-speech.png" alt="" className="trail-ghost trail-2" aria-hidden="true" />
        <img src="/lass/lass-speech.png" alt="" className="trail-ghost trail-3" aria-hidden="true" />
        <img src="/lass/lass-speech.png" alt="" className="trail-ghost trail-4" aria-hidden="true" />
        <img src="/lass/lass-speech.png" alt="" className="trail-ghost trail-5" aria-hidden="true" />
        <img src="/lass/lass-speech.png" alt="" className="trail-ghost trail-6" aria-hidden="true" />
        <img src="/lass/lass-speech.png" alt="" className="trail-ghost trail-7" aria-hidden="true" />
        <img src="/lass/lass-speech.png" alt="" className="trail-ghost trail-8" aria-hidden="true" />
        
        {/* Stationary ghosts */}
        <img src="/lass/lass-speech.png" alt="" className="ghost-layer ghost-1" aria-hidden="true" />
        <img src="/lass/lass-speech.png" alt="" className="ghost-layer ghost-2" aria-hidden="true" />
        <img src="/lass/lass-speech.png" alt="" className="ghost-layer ghost-3" aria-hidden="true" />
        
        {/* Main character */}
        <img src="/lass/lass-speech.png" alt="Lass Speaking" className="main-character" />
      </div>
