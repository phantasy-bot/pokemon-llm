        ...
        try:
            ...
            if hasattr(zai_vision_client, 'analyze_image_sync'):
                ...
                factual_prompt = (
                    ...
                    "- Tall grass appears as DENSE DARK GREEN or CYAN colored tile patterns\n"
                    "- It has a 'spiky' or 'bristly' texture that stands out from flat floor tiles\n"
                    "- If the player is standing IN tall grass, report: 'player in tall grass'\n"
                    "- Tall grass is where WILD POKEMON appear - entering it triggers encounters\n"
                    "- In early game, Professor Oak stops you if you try to enter tall grass without a Pokemon\n"
                    "- If you see dense green/cyan textured tiles near the player, note: 'tall grass nearby [direction]'\n\n"
